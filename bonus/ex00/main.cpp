...
int main(){
...

  {
    ...
    try{
      ...
      std::cout<<"account 0:"<<b1[0]<<std::endl;
      std::cout<<"account 1:"<<b1[1]<<std::endl;
      std::cout<<"account 2:"<<b1[2]<<std::endl;
      std::cout<<"end example of  operator []"<<std::endl;
  ...
  // }
  {
    ...
    // std::vector<Bank::Account> clients = b1.getClients();
    // for(std::vector<Bank::Account>::iterator it=clients.begin(); it != clients.end();++it){
    //   std::cout<<*it;
    // }
